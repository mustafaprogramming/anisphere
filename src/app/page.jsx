    ...
    <main >
      ...
      <div className='bg-black xs:text-base text-sm text-orange-100 xl:px-28 px-5 -mt-2 pb-12'>
        ...
        <aside className="flex flex-col gap-4 xl:max-w-4xl ">
          ...
          <p>Do you know that according to Google, the monthly search volume for anime related topics is up to over 1 Billion times? Anime is famous worldwide and it is no wonder we&lsquo;ve seen a sharp rise in the number of free anime streaming sites.
          </p>
          <p>Just like free online movie streaming sites, anime watching sites are not created equally, some are better than the rest, so we&lsquo;ve decided to build AniSphere to be one of the best free anime streaming site for all anime fans on the world.
          </p>
          ...
          <div>Before building AniSphere, we&lsquo;ve checked many other free anime sites, and learnt from them. We only keep the good things and remove all the bad things from all the competitors, to put it in our AniSphere website. Let&lsquo;s see how we&lsquo;re so confident about being the best site for anime streaming:
            <ul className="list-disc py-4 px-5 gap-4 flex flex-col">
                ...
                <li><span className="font-bold mr-2">Streaming experience:</span>Compared to other anime streaming sites, the loading speed at AniSphere is faster. Downloading is just as easy as streaming, you won&lsquo;t have any problem saving the videos to watch offline later.</li>
                ...
                <li><span className="font-bold mr-2">User interface:</span>Our UI and UX makes it easy for anyone, no matter how old you are, how long have you been on the Internet. Literally, you can figure out how to navigate our site after a quick look. If you want to watch a specific title, search for it via the search box. If you want to look for suggestions, you can use the site&lsquo;s categories or simply scroll down for new releases.
                </li>
                <li><span className="font-bold mr-2">Device compatibility:</span>AniSphere works alright on both your mobile and desktop. However, we&lsquo;d recommend you use your desktop for a smoother streaming experience.</li>
            ...
            So if you&lsquo;re looking for a trustworthy and safe site for your Anime streaming, let&lsquo;s give AniSphere a try. And if you like us, please help us to spread the words and do not forget to bookmark our site.
